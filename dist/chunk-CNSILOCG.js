...
var pid = process.pid;
var DEBUG = false;
async function getMasstackToken(environment) {
  try {
...
async function connectToRemoteServer(client, serverUrl, authProvider, headers, authInitializer, transportStrategy = "http-first", authEnvironment, recursionReasons = /* @__PURE__ */ new Set()) {
